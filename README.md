...
Since the dashboard contains all data properties inline, it requires zero server setup, data pipelines, or database backends. 

1. Clone this repository:
   ```bash
   git clone [https://github.com/hoffmanap/SHPA.git](https://github.com/hoffmanap/SHPA.git)
